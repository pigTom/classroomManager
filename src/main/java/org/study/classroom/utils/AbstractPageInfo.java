...
abstract public class AbstractPageInfo <T>{
	 ...
	 * 
	 * @param currPage return current page that shown on html page
	 */
	 ...
	 * 
	 * @return return the list date contained by this pageInfo
	 */
	...
	public String toString() {
		return "UserPageInfo [currPage=" + currPage + ", totalPage=" + totalPage
				+ ", evePageNum=" + evePageNum + ", realPageNum=" + realPageNum
				+ ", data=" + data + "]";
	}

	protected abstract void update(T t1, T t2);
}
