...
public class Constants {
    ...
    public static final String STUDENT_PATH = "WEB-INF/jsp/admin/student_list";
    public static final String TEACHER_PATH = "WEB-INF/jsp/admin/teacher_list";
    public static final String STUDENT_PAGES = "student_pages";
    public static final String TEACHER_PAGES = "teacher_pages";
    public static final String CLASSROOM_PATH = "WEB-INF/jsp/admin/classroom";
    public static final String CLASSROOM_PAGES = "classroom_pages";
    public static final String COURSE_PATH = "WEB-INF/jsp/classroom/course";
    public static final String COURSE_PAGES = "course_pages";
    public static final String BASE_USER_PATH = "WEB-INF/jsp/user/";
}
