...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/admin/students.js"></script>
<div class="m-b-md">
...
<div class="table-responsive">
        ...
        <c:if test="${student_pages != null}">
            <c:forEach items="${student_pages.data}" var="student" varStatus="status">
                ...
                <tr class="data">
                    ...
                    <td class="row"><fmt:formatDate value="${student.createTime}" pattern="yyyy-MM-dd"/></td>
                    <td class="row">
                        <button onclick="deleteUser(${student.id})">删除</button>
                    </td>
                    <td class="row">
                        <button onclick="update1(${student.id})">重置密码</button>
                    </td>
                    <td class="row">
    ...
    <span style="align-content: center">&ensp;&ensp;&ensp;&ensp;&ensp; 第${student_pages.currPage}页</span>
</div>
