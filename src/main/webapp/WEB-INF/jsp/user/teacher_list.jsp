...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/user/teacher_list.js"></script>
<div class="m-b-md">
...
<div class="table-responsive">
        ...
        <c:if test="${teacher_pages != null}">
            <c:forEach items="${teacher_pages.data}" var="teacher" varStatus="status">
                ...
                <tr class="data">
                    ...
                    <td class="row">${teacher.createTime}</td>
                    <td class="row">
                        <button onclick="deleteUser(${teacher.id})">删除</button>
                    </td>
                    <td class="row">
                        <button onclick="update1(${teacher.id})">修改密码</button>
                    </td>
                    <td class="row">
    ...
    <span style="align-content: center">&ensp;&ensp;&ensp;当前第${teacher_pages.currPage}页</span>
</div>
